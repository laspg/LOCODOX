function ssp=soundspeed90(S,T90,D,equation);
...
% ------------------------------------------------------------
% Modif 6/11/03 C. Lagadec
% 1) le paramètre Température est supposé être une T90 :
%    passage de T90 à T pour le calcul
%
% 2) suppression du calcul avec l'option 'state'
% -------------------------------------------------------------
...
% SOUND SPEED RETURN
   ...
   error('soundspeed90: Unrecognizable equation specified!');
end;
