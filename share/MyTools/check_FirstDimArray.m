% check_FirstDimArray checks that the first dimension of all the array in the
...
%
% DESCRIPTION
% check_FirstDimArray check that the first dimension of all the array in the
...
%                       first place for all the arrays. Required field
%                       for each variable : firstdimname (double)
%                       Example : 
%                           Co.firstdimname = 'N_PROF'
%
% CALL :
%
% SEE ALSO
...
function [Co] = check_FirstDimArray(Co,DIMNAME)
...
% =========================================================================
%% Check for the First dimension for all fields.
% =========================================================================
...
% =========================================================================
%% Change the dimension order if DIMNAME is not the first dimension
% =========================================================================
if testonechange==0
