...
%  History
%  20/04/2016 - ebrion, ALTRAN, emilie.brion@altran.com
%       Modify from built-in Matlab lsitdlg to make the GUI windowstyle normal,
%       and not modal.
...
%% getnicedialoglocation callback
...
%% setdefaultbutton callback
    ...
    function setdefaultbutton(figHandle, btnHandle)
        ...
        % Nargin Check
        %error(nargchk(1, 2, nargin))  % Warning: NARGCHK will be removed
        %                                in a future release. Use NARGINCHK
